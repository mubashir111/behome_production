        ...
        try {
            ...
            if ($returnAndRefund) {
                ...
                DB::transaction(function () use ($request, $order) {
                    ...
                    if ($request->products) {
                        ...
                        foreach ($products as $product) {
                            ...
                            ReturnAndRefundProduct::create([
                                ...
                                'variation_id'         => $product['has_variation'] ? ($product['variation_id'] ?: null) : null,
                                'variation_names'      => $product['has_variation'] ? ($product['variation_names'] ?: null) : null,
                    ...
                    AuditLogger::returnSubmitted(
                        \App\Models\Order::find($request->order_id),
                        optional($this->returnAndRefund->returnReason)->title ?? '',
                        $request->note ?? ''
                    );
                });
