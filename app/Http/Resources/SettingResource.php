...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'site_currency_position' => config('app.currency_position'),
            'site_digit_after_decimal_point' => config('app.currency_decimal_point'),
            'site_default_currency_symbol' => config('app.currency_symbol'),
            ...
            'shipping_setup_area_wise_default_cost' => $this->info['shipping_setup_area_wise_default_cost'] ?? '0',
            ...
            'otp_expire_time' => $this->info['otp_expire_time'] ?? '10',
