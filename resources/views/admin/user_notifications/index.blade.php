            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <form id="del-notif-{{ $n->id }}" method="POST" action="{{ route('admin.user-notifications.destroy', $n) }}">
                            @csrf @method('DELETE')
                            <button type="button" onclick="confirmSubmit('del-notif-{{ $n->id }}', { title: 'Delete Notification', message: 'Are you sure you want to delete this notification record?', confirmText: 'Yes, Delete', type: 'danger' })" class="admin-btn-danger-sm">
