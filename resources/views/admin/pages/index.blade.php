...
<div class="max-w-[1200px] mx-auto pb-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-md hover:border-indigo-200 transition-all duration-200 group">
            ...
            <p class="text-xs text-slate-400 font-mono mb-1">/{{ $page->slug }}</p>
            @if($page->is_system)
                <span class="inline-flex items-center gap-1 text-xs font-medium text-amber-700 bg-amber-50 border border-amber-200 rounded-full px-2 py-0.5 mb-3">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0-6a2 2 0 100-4 2 2 0 000 4z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 11V7a5 5 0 00-10 0v4M5 11h14a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1v-7a1 1 0 011-1z"/></svg>
                    System page
                </span>
            @else
                <div class="mb-3"></div>
            ...
            <div class="flex items-center gap-2">
                ...
                @if($page->is_system)
                    <div class="p-2 rounded-lg bg-slate-50 border border-slate-200 text-slate-300 cursor-not-allowed" title="System pages cannot be deleted">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0 0v2m0-2h2m-2 0H10m2-6V7a4 4 0 00-8 0v4H3v10h18V11h-1z"/>
                        </svg>
                    </div>
                @else
                    <button type="button"
