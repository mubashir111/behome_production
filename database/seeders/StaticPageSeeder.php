    ...
    public function run(): void
    {
        $pages = [
            [
                ...
                'sections'         => json_encode([
                    'hero' => [
                        ...
                        'description' => 'Behom was founded with a vision to bring world-class architectural decor and luxury furniture to homes everywhere. We curate only the finest pieces, crafted by artisans who share our passion for design excellence.',
                    ],
                    'features' => [
                        ['number' => '01', 'year' => '2009', 'title' => 'Business founded',        'description' => 'Behom was founded with a vision to bring world-class architectural decor to homes everywhere.'],
                        ...
                        ['number' => '04', 'year' => '2020', 'title' => 'Revenues of millions',    'description' => 'Behom crossed the milestone of millions in revenue, cementing our position as a market leader.'],
                    ],
                    'stats' => [
                ...
                'meta_title'       => 'About Us | Behom',
                'meta_description' => 'Learn the story behind Behom — a premium architectural decor and luxury furniture brand.',
                'is_active'        => true,
                'is_system'        => true,
            ],
            [
                ...
                'sections'         => json_encode([
                    ...
                    'emails'        => ['hello@behom.com'],
                    'careers_email' => 'careers@behom.com',
                    'map_query'     => '27 Old Gloucester Street London',
                ]),
                'meta_title'       => 'Contact Us | Behom',
                'meta_description' => 'Get in touch with the Behom team. We\'d love to hear from you.',
                'is_active'        => true,
                'is_system'        => true,
            ],
            [
            ...
            [
                'slug'             => 'blog',
                'title'            => 'Our Blog',
                'content'          => 'Explore interior design inspiration, home decor trends, styling guides, and expert tips from the Behom team.',
                'sections'         => json_encode([]),
                'meta_title'       => 'Blog | Behom',
                'meta_description' => 'Explore interior design inspiration, home decor trends, styling guides, and expert tips from the Behom team.',
                'is_active'        => true,
                'is_system'        => true,
            ],
            [
                ...
                'sections'         => json_encode([]),
                'meta_title'       => 'Shipping Policy | Behom',
                'meta_description' => 'Read the Behom Shipping Policy — delivery times, shipping costs, tracking, and more.',
                'is_active'        => true,
                'is_system'        => true,
            ],
            [
                ...
                'sections'         => json_encode([]),
                'meta_title'       => 'Returns & Exchanges | Behom',
                'meta_description' => 'Read the Behom Returns & Exchanges policy — 30-day returns, how to start a return, and refund timelines.',
                'is_active'        => true,
                'is_system'        => true,
            ],
            [
