      ...
      <nav class="py-3 pb-5">
        ...
        >
          ...
          <li v-if="$can('database-backup')" class="nav-item">
            <a
              href="https://docs.SIGNOWN TECHNOLOGIES.tech/acculance/#section-changelog"
              class="nav-link"
              target="__blank"
            >
          ...
          <li class="nav-item">
            <a
              class="nav-link"
              href="https://SIGNOWN TECHNOLOGIESbd.freshdesk.com/support/login"
              target="__blank"
            >
          ...
          <li class="nav-item">
            <a
              href="https://docs.SIGNOWN TECHNOLOGIES.tech/acculance/"
              class="nav-link"
              target="__blank"
            >
              <i class="nav-icon fas fa-book" />
