...
<head>
    ...
    <meta name="author" content="SIGNOWN TECHNOLOGIES">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="https://SIGNOWN TECHNOLOGIES.net/contact-us" target="_blank"
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="hero-content">
                        ...
                        <div class="button wow fadeInLeft" data-wow-delay="1s">
                            ...
                            <a href="http://docs.SIGNOWN TECHNOLOGIES.tech/acculance/" target="_blank" class="btn btn-alt">
                                Documentation
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="single-table wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <div class="table-head">
                            ...
                            <div class="button mt-5">
                                <a href="https://SIGNOWN TECHNOLOGIES.net/contact-us" target="_blank" class="btn">Contact
                                    Us</a>
                            </div>
                        </div>
                        <!-- End Table Head -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 text-center col-12">
                        ...
                        <div class="single-footer f-about">
                            ...
                            <ul class="social">
                                <li><a href="https://SIGNOWN TECHNOLOGIES.net" target="_blank"><i
                                            class="lni lni-website"></i></a></li>
                                <li><a href="https://www.facebook.com/SIGNOWN TECHNOLOGIESbd" target="_blank"><i
                                            class="lni lni-facebook-filled"></i></a></li>
                                <li><a href="https://twitter.com/SIGNOWN TECHNOLOGIESbd" target="_blank"><i
                                            class="lni lni-twitter-original"></i></a></li>
                                <li><a href="https://www.instagram.com/SIGNOWN TECHNOLOGIES_int/" target="_blank"><i
                                            class="lni lni-instagram"></i></a></li>
                                <li><a href="https://www.linkedin.com/in/code-shaper-7b8a0513b" target="_blank"><i
                                            class="lni lni-linkedin-original"></i></a></li>
                                <li><a href="https://www.pinterest.com/SIGNOWN TECHNOLOGIESbd/" target="_blank"><i
                                            class="lni lni-pinterest"></i></a></li>
                            </ul>
                            <p class="copyright-text">Copyright &copy; By <a href="https://SIGNOWN TECHNOLOGIES.net/"
                                    rel="nofollow" target="_blank">SIGNOWN TECHNOLOGIES</a>
                            </p>
                        </div>
                        <!-- End Single Widget -->
                    </div>
