...
function PaymentSuccessContent() {
    ...
    // Safety timeout — if verification hangs > 15s, let the user navigate away
    useEffect(() => {
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-8 text-center">
                                <div className="bg-dark-gray border-radius-6px p-50px xs-p-20px">
                                    ...
                                    {timedOut ? (
                                        <p className="text-gray mb-20px">
                                            ...
                                            <Link href="/account" className="text-base-color">Check My Orders</Link> to see if it went through.
                                        </p>
                                    ) : (
